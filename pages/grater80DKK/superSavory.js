...
choiceBtn1.addEventListener("click", () => {
    location.href ='https://aarhusstreetfood.com/en/burger-menu.html'
})

choiceBtn2.addEventListener("click", () => {
    location.href ='https://aarhusstreetfood.com/en/fettuccine-m-troffel-og-champignon.html'
})

choiceBtn3.addEventListener("click", () => {
    location.href ='https://aarhusstreetfood.com/en/spicy-okse-bowl.html'
})

choiceBtn4.addEventListener("click", () => {
    location.href ='https://aarhusstreetfood.com/en/fillet-steak-menu.html'
})