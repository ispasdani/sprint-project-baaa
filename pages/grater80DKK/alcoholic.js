...
choiceBtn1.addEventListener("click", () => {
    location.href ='https://aarhusstreetfood.com/en/deutz-2011-blanc-de-blancs.html'
})

choiceBtn2.addEventListener("click", () => {
    location.href ='https://aarhusstreetfood.com/en/beer-geek-fudgsicle-daseol-330ml.html'
})
...
choiceBtn4.addEventListener("click", () => {
    location.href ='https://aarhusstreetfood.com/en/moscow-mule.html'
})